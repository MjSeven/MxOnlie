...
class UploadImageView(LoginRequiredView, View):
    """
    用户修改头像
    """
    def post(self, request):
...
class SendEmailCodeView(LoginRequiredView, View):
    """
    个人中心发送邮箱验证码
    """
    def get(self, request):
...
class UpdateEmailView(LoginRequiredView, View):
    """
    修改个人邮箱
    """
    def post(self, request):
...
class MyCourseView(LoginRequiredView, View):
    """
    我的课程
    """
    def get(self, request):
...
class MyFavOrgView(LoginRequiredView, View):
    """
    我的收藏课程
    """
    def get(self, request):
...
class MyFavTeacherView(LoginRequiredView, View):
    """
    我的收藏授课讲师
    """
...
class MyFavCourseView(LoginRequiredView, View):
    """
    我的收藏课程
    """
...
class MymessageView(LoginRequiredView, View):
    """
    我的消息
    """
    def get(self, request):
